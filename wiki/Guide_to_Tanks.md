...
и, *работать слажено*. Ниже представлены роли как и для танкового экипажа (все роли), так и общие для пехоты (водитель и стрелок-пулемётчик).
...
## РОЛИ
  ...
  - **КОМАНДИР (COMMANDER)**: Командир бронетехники требует от себя очень
    **БОЛЬШОЙ** коммуникации с экипажем. Именно Вы, командир, и командуете.
    ...
    Вам необходимо сесть на *кресло командира* (commander's seat). Как только 
  ...
  - **НАВОДЧИК ОРУДИЯ (GUNNER)**: Как наводчик, Вы должны *вводить параметры*, указанные командиром.
    В зависимости от техники, Вам, возможно, придётся **самостоятельно заряжать снаряды в орудие** (автомат заряжания) или же, напротив, 
  ...
  - **СТРЕЛОК-ПУЛЕМЁТЧИК (MACHINE-GUNNER)**: Ожидается, что Вы будете ответственны за пулемёт впереди Вашей техники. 
    ...
    (обычно там находятся ленты) и после *кликните по пулемёту лентой*, чтобы его зарядить. Когда пулемёт будет заряжен,
  ...
  - **ВОДИТЕЛЬ (DRIVER)**: **За Вами закреплено управление техникой**. Ваша задача довольна сложная на первый взгляд, однако не стоит отчаиваться!
    ...
    *завязана живучесть управляемой техники* экипажем. *Во-вторых*, чтобы водить - *надо знать управление*, которое будет представлено далее.
    Чтобы завести машину или танк и управлять ими, необходимо: сесть в кресло водителя, использовать активной только руку с рулём (также в меню IC есть кнопки актив хэнд и секонд хэнд), затем нажать "Z". Нажатием "Z" Вы активируете движок. Чтобы двигаться вперёд, достаточно нажать "Z" ещё раз, предварительно нажав "W" (Ваше передвижение будет в сторону носа техники). Последующие нажатия "Z" будут переключать передачи, отчего Ваша техника будет двигаться быстрее. Нажатием "C" Вы, напротив, уменьшите передачу, вследствие чего техника станет двигаться медленее. И таким образом можно остановить технику. Чтобы езжать реверсом, задним ходом, надо нажать "S" и снова прожать "Z", 
    когда Ваша техника стоит на месте. Для поворота налево или направо необходимо нажимать соотвествующие кнопки "A" и "D". Для заглушения движка достаточно остановиться и прожать "C".
...
## СОВЕТЫ
* Техника может только двигаться вперёд или назад и поворачиваться влево или вправо. Боковое движение не представляется возможным, только если не манёврами. Так что это 
точно займёт некоторое время для того, чтобы приноровиться к управлению. Потренируйтесь на джипах или машинах первое время.
...
* Вы не можете поворачиваться вокруг своей оси, стоя на одном месте. Вам необходимо двигаться, чтобы разворачиваться. Но Вы можете поворачиваться со сбитой гусеницей, однако это требует некоторого усилия.
...
Если ты *покинешь танк из-за того, что там просто сбитая гусеница*, **то лучше убейся**. Ты не танкист, а мудила. Настоящий танкист *остаётся внутри своей машины* до тех пор, пока она не превратится в швейцарский сыр. Этот вооружённый "**гроб**", позволяет тебе быть передвигающимся ДОТом.
  - **Вся модульная техника имеет проекцию 5x5 (танки и машины таковыми являются).** Знание проекции (или зоны) позволит *отточить навыки вождения транспорта*. 
    ...
    определённому интерьеру техники, например, водительскому сиденью. У многой техники оно находится *вплотную к краю этой зоны*. **Танки - это одни из самых подходящих полностью под описание проекции техника.**
  ...
  - **Экипаж танка может управлять танком плавно и лучше, если имеется хотя бы один Танкист-АС.** Однако множество бойцов не могут пользоваться танком эффективно из-за их самих. 
...
#### ПРИМЕР ИСПОЛЬЗОВАНИЯ ТЕОРЕМЫ ПРОЕКЦИИ
